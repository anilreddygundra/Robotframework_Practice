...
namespace appiumclient
{
    public class GmailDraft
    {
        ...
        public void TestCase()
        {
            ...
            driver.FindElementByXPath("/hierarchy/android.widget.FrameLayout/android.widget.LinearLayout/android.widget.FrameLayout/android.widget.FrameLayout/android.widget.FrameLayout/androidx.drawerlayout.widget.DrawerLayout/android.widget.FrameLayout/android.widget.FrameLayout/android.support.v7.widget.RecyclerView/android.widget.LinearLayout[12]/android.widget.LinearLayout").Click();
            ...
            //driver.FindElementById("//android.widget.ImageView[@content-desc=\"More options\"]").Click();
            driver.FindElementById("com.google.android.gm:id/discard_drafts").Click();
